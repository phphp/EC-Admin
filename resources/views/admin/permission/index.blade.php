    ...
    <div class="container mb-1">
        <div class="row align-items-center">
            ...
            <div class="col text-right">
                <a class="btn btn-primary btn-sm" href="{{ route('permissions.create') }}" role="button">
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{ route('permissions.edit', ['id'=>$permission->id]) }}">{{ $permission->name }}</a></td>
                    <td>{{ $permission->action }}</td>
                    <td>{{ $permission->uri }}</td>
                    <td>
                        <a href="{{ route('permissions.edit', ['id'=>$permission->id]) }}" class="float-left mr-1">
                            <button class="btn btn-primary btn-sm"><i class="iconfont icon-edit"></i></button>
                        </a>
                        <button class="btn btn-danger btn-sm float-left"
                            data-toggle="modal"
                            data-target="#deleteModal"
                            data-url="{{ route('permissions.destroy', ['id'=>$permission->id]) }}"
                            >
