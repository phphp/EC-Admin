...
@section('content')
    ...
    <div class="col-md-7" id="app">
        <form action="{{ route('banner.update', ['id'=>$banner->id]) }}" method="post" enctype="multipart/form-data" id="ajaxForm">
            {{csrf_field()}}
            {{ method_field('PUT') }}
            ...
            <div class="form-group">
                <label>描述</label>
                <input v-model="description" type="text" class="form-control" name="description" placeholder="description">
            </div>
            ...
            <div id="sortable">
                <div class="moveable border border-secondary p-3 rounded mb-1" v-for="(image) in images" v-bind:key="image.no" v-bind:id="image.no">
                    ...
                    <img style="object-fit: contain" v-bind:src="image.src" referrerpolicy="no-referrer" width="50" height="50">
                    <div class="form-group" v-show="!image.image_id">
                    ...
                    <div class="form-group" v-show="image.type == 2 || image.image_id">
                        <label>使用已有图片</label>
                        <input v-model="image.image_id" type="text" class="form-control" placeholder="填写图片 ID">
                    </div>

                    <div v-show="image.type == 1 && !image.image_id">
                        <div class="form-group">
                            <label>title</label>
                            <input v-model="image.title" type="text" class="form-control" placeholder="title">
                        </div>
                        <div class="form-group">
                            <label>alt</label>
                            <input v-model="image.alt" type="text" class="form-control" placeholder="alt">
                        </div>
                        <div class="form-group">
                    ...
                    <div v-show="image.type == 0 && !image.image_id">
                        <div class="form-group">
                            <label>title</label>
                            <input v-model="image.title" type="text" class="form-control" placeholder="title">
                        </div>
